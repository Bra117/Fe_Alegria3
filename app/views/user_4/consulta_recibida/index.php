...
<html lang="en">
    <head>
        ...
        <title>Consultas-recibidas Pedagog&iacutea</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Consulta-Recibidas Pedagog&iacutea</h1>
                        ...
                        <div class="card mb-4">
                            ...
                            <!---------- TABLA SOLICITUDES ----------------->
                            <div name = "consulta" id = "consulta"></div>
                            <!---------- END TABLA SOLICITUDES ------------->
                        </div>
                    </div>
                </main>

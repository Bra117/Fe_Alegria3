...
<html lang="en">
    <head>
        ...
        <title>Secciones y Estad&iacutesticas</title>
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapsePages14" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    ...
                                    <a class="nav-link" href="pedagogia">
                                        <div class="sb-nav-link"></div>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">  
                        <h1 class="mt-4">Estad&iacutesticas E Inasistencias</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="user_1"><?php echo $_SESSION['usuario'];?></a></li>
                            <li class="breadcrumb-item active"><?php echo $_SESSION["email"]?></li>
                        </ol>

                         <!------------------------------- SELECT--------------------------------------->
                        <select id = "SelectSeccion" class = "SelectSeccion" onchange="funcSelect(this.value);"></select>
                        <!--------------------------- END SELECT ---------------------------------------><br>
                     ...
                     <form id = "ModalForm" name = "ModalForm" class = "ModalForm">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel" style = "color:green">Actualizar Estudiante</h5>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <input type = "hidden" id = "id_student" name = "id_student">
                                             <div  id = "SelectSeccion" name = "SelectSeccion" class = "SelectSeccion"></div>
                                        </div>
                       ...
                       <!----------------------- END MODAL PARA ACTUALIZAR ESTUDIANTE --------------------->

                        <br><div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-chart-area me-1"></i>
                            Gr&aacutefica Inasistencias
                            </div>
                            <div id="contenedor" class="card-body">
                                <canvas id="grafica" height="130" width="200%"></canvas></div>
                       ...
                       <!--div class="card mb-4">
                            ...
                            <div class="card-body"><canvas id="grafica2"  width="100%" height="30"></canvas></div>
                            <div class="card-footer small text-muted">Actualizado Ayer a las 11:59 PM</div>
                       </div-->
                    </div>
                </main>

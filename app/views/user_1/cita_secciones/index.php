...
<html lang="en">
    <head>
        ...
        <title>Estad&iacutesticas- Consulta por Secciones</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">  
                        <h1 class="mt-4">Estad&iacutesticas- Consulta por Secciones</h1>
                        <ol class="breadcrumb mb-4">
                         ...
                         <!------------------------------- SELECT--------------------------------------->
                        <select id = "SelectSeccion" class = "SelectSeccion" onchange="funcSelect(this.value);">
                     ...
                     <form id = "ModalForm" name = "ModalForm" class = "ModalForm">
                       ...
                       <!----------------------- MODAL PARA ACTUALIZAR ESTUDIANTE --------------------->
                        ...
                        <br><div class="card mb-4">
                            ...
                            Gr&aacutefica Consulta por Secciones
                            </div>

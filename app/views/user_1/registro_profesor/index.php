            ...
            <div id="layoutSidenav_content" style= "">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4" style =  "">Registro Docente</h1>
                        ...
                        <div class="card-body_1" style = "margin-top: 150px;">
                            <form id = "form" class = "form">
                                ...
                                <fieldset>
                                    ...
                                    <input onblur="myFunction()" id = "cedula" name = "cedula" type = "cedula"/>
                                    <p  class= "parrafo" id = "parrafo"></p>
                                </fieldset><br>
                                <fieldset><br>
                                    <label id = "Nombre_Label" for = "nombre">Nombre</label>
                                    <input id = "nombre" name = "nombre" type = "tex"/>
                                </fieldset><br>
                                <fieldset><br>
                                ...
                                <fieldset><br>
                                <label id = "Select_Label">Cargo Institucional:</label>
                                    <select id = select2 name = "select"> 
                                        <stronge><option value = "2">Profesor@</stronge></option>
                                        <stronge><option value = "1">Director@</option></stronge>
                                        <stronge><option value = "3">Psicopedagoga</option></stronge>
                                    </select>
                                </fieldset></br>
                                <div id = "Btn_Enviar1" style = "margin-right: 200px;" class="wrapper">

                    ...
                    <div class="container-fluid px-4">
                                ...
                                <div class="modal-dialog" role="document" style = "margin-right: 300px;">
                                    <div class="modal-content" style="width: 350px;">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel" style = "color:green">Actualizar Personal</h5>
                        ...
                        <div class="row">
                            <div class = "col-xl-3 .col-md-6">
                                <div class = "profesores" id = "profesores"></div>
                           </div>

                            <div class = "col-xl-3 .col-md-6 ">
                                <div class = "directivo" id = "directivo"></div>
                            </div>

                            <div class="col-xl-3 col-md-6">
                              <div class = "alumnos" id = "alumnos"></div>
                            </div>
                        ...
                        <div class="card mb-4">
                            ...
                            <!---------- TABLA PROFESOR ----------------->
                            <div id = "teacher" name = "teacher"></div>
                            <!---------- END TABLA PROFESOR ------------->
                        </div>
                    </div>
                </main>

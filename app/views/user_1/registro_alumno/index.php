            ...
            <div id="layoutSidenav_content" style= "">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4" style =  "">Registro Estudiantil</h1>
                        ...
                        <div class="card-body_1" style = "margin-top: 150px;">
                            <form id = "form" class = "form">
                                <fieldset>
                                    <label id = "Cedula_Label" for="cedula">C&eacutedula</label>
                                    <input onblur="myFunction()" clas = "form-control" id="cedula" name = "cedula" type="cedula"/>
                                    <p class= "parrafo" id = "parrafo"></p>
                                </fieldset><br>
                                <fieldset><br>
                                    <label id="Nombre_Label" for="nombre">Nombre</label>
                                    <input id="nombre" name = "nombre" type="nombre" maxlength = "50" />
                                </fieldset><br>
                                <fieldset><br>
                                <label id = "Apellido_Label" for="apellido">Apellido</label>
                                    <input id="apellido" name = "apellido" type="apellido" maxlength = "50" />
                                </fieldset><br>
                                <fieldset><br>
                                    <label for="fecha_nac" id = "fecha_nac_Label">Fecha de nacimiento</label>
                                    <input id="fecha_nac" name = "fecha_nac" type="date"/>
                                </fieldset><br>
                                <fieldset><br>
                                    <label id = "Ano_Label" for="ano y seccion">Año y Sección</label><br>
                                    <select  name="select" class = "form-select" style = "width: 70px;" id="select">Año y Seccion</select>
                                </fieldset></br>
                                <fieldset><br>
                                    <label id = "Sexo_Label" for = "Sexo">Sexo</label><br>
                                    <select  class = "form-select" style = "width: 120px;" name="select1" id="select1">Sexo
                                        <option value = "1">Masculino</option>
                                        <option value = "2">Femenino</option>
                                    </select>
                                </fieldset></br>
                                <div id = "Btn_Enviar" class="wrapper">

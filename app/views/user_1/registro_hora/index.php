            ...
            <div style = "background-color: #f2f3eb;" id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Registrar Hora</h1>
                                ...
                                <div class="modal-dialog" role="document" style = "margin-right: 300px;">
                                    <div class="modal-content" style="width: 350px;">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel" style = "color:green">Actualizar Hora</h5>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <input type = "hidden" id = "id_hora" name = "id_hora">
                                        </div>
                        ...
                        <div class="card-body_1" style = "margin-top: 60px;">
                            <form id = "form1" class = "form1">
                               <div style = "width: 300px; margin-left: 880px;" class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="basic-addon1"><strong>Hora:</strong></span>
                                    </div>
                                    <input  type="text" class="form-control" placeholder=" 07:00 AM / 12:00 PM" aria-label = "Username" aria-describedby="basic-addon1" id = "hora" name = "hora">
                                </div>
                            </form>
                            <button class = "form100" id = "form_button1" style = "margin-left: 439px;">
                                Registrar
                            </button>   
                        </div><br>                             
                       <div class="card mb-4">

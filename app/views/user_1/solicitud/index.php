...
<html lang="en">
    <head>
        ...
        <title>Estad&iacutesticas Solicitudes</title>
                    ...
                    <div class="container-fluid px-4">
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel" style = "color:green">Actualizar Profesor</h5>
                                        ...
                                        <form id = "form1" class = "form1">
                                            ...
                                            <div class = "form-group"><br>
                                                <Select name = "rol" id = "rol">
                                                    <option>Rol</option>
                                                    <option value = "1">Directiv@</option>
                       ...
                       <!----------------------- MODAL PARA ACTUALIZAR PROFESOR --------------------->
                        ...
                        <div class="card mb-4">
                            ...
                            <!---------- TABLA SOLICITUDES ----------------->
                            <div name = "solicitud" id = "solicitud"></div>
                        ...
                        <br><div class="card mb-4">
                            ...
                            Gr&aacutefica Solicitudes
                            </div>
                            <div class="card-body"><canvas id="grafica"  width="100%" height="30"></canvas>
                            </div>

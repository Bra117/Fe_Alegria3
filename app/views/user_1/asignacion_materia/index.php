            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Asignar Materia</h1>
                        ...
                        <div class="card-body_1" style = "margin-top: 250px;">
                            <form id = "form" class = "form">
                                <fieldset>
                                    <label id = "label_profesor" style = "margin-top: -50px;">Profesor</label>
                                    <select id = "selectprofesor" name = "selectprofesor" class = "form-select selectprofesor" style = " width: 250px; margin-top: -40px; margin-left: 400px; background-color: white; color: black">Profesor</select>
                                </fieldset><br>
                                <fieldset><br>
                                    <label id = "label_profesor" style = "margin-top: -10px;">Materia</label>
                                    <select id = "selectmateria" name = "selectmateria" class = "form-select selectmateria" style = " width: 250px; margin-top: -1px; margin-left: 400px; background-color: white; color: black">Materia</select>
                                </fieldset><br>
                                <fieldset><br>
                                    <label id = "label_profesor" style = "margin-top: -10px;">Hora</label>
                                    <select id = "selecthoras" name = "selecthoras" class = "form-select selecthoras" style = " width: 250px; margin-top: -1px; margin-left: 400px; background-color: white; color: black">Horas</select>
                                </fieldset><br>
                           </form>
                           <button id = "form_button" style = "margin-left: 370px; margin-top: 50px;">
                                Registrar
                            </button>
                            </div><br>
                    </div>

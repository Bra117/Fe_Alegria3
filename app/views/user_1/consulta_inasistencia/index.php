            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Consulta Inasistencias Estudiantes</h1>
                        ...
                        <form class = "formulario3" id= "formulario3"><br>       					      
       					...
       					<button class = "button"  id = "button"> Buscar</button><br>
                        ...
                        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header" style = "justify-content: center;"></div>
                                    <div class="modal-body" style = "text-align: center;">
                                        <div class = "form" id = "form" name = "form"></div>
                                        <p><h4><strong>¿Deseas Agendar?</strong></h4></p>
                                    </div>
                                    <div class = 'modal-footer' style = "justify-content: center;">
                                        <button type = 'button' style = "width: 120px;" class = 'btn btn-danger' data-dismiss='modal'>No</button>
                                        <button  type = 'button' id = 'BtnActua' class = 'btn btn-info' style = "color: white;">Agendar Cita</button>
                                        <select id =  "botones"  name =  "botones"  class =  "botones"></select>
                                    </div>
                                </div>
                            </div>
                        </div>

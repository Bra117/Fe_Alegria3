...
<html lang="en">
    <head>
        ...
        <link rel = "stylesheet" href = "<?php echo APP;?>app/plugins/fontawesome-free/css/solid.min.css"/>
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="consulta">Consulta Estudiantes</a>
            ...
            <div style = "background-color: #f2f3eb;" id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Registrar Materia</h1>
                        ...
                        <form id = "ModalForm" name = "ModalForm" class = "ModalForm">
                            <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document" style = "margin-right: 300px;">
                                    <div class="modal-content" style="width: 350px;">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel" style = "color:green">Actualizar Seccion</h5>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <input type = "hidden" id = "id_aseccion" name = "id_aseccion">
                                        </div>
                        ...
                        <div class="card-body_1" style = "margin-top: 60px;">
                            <form id = "form1" class = "form1">
                               <div style = "width: 200px; margin-left: 950px;" class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="basic-addon1"><strong>A&ntildeo:</strong></span>
                                    </div>
                                    <input maxlength = "1" minlength = "1"  type="text" class="form-control" aria-label = "Username" aria-describedby="basic-addon1" id = "ano" name = "ano">
                                </div>
                                    
                                <div style = "width: 200px; margin-left: 950px;" class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="basic-addon1"><strong>Secci&oacuten</strong></span>
                                    </div>
                                    <input maxlength = "1" minlength = "1" maxlength = "1" minlength = "1"  type="text" class="form-control" aria-label = "Username" aria-describedby="basic-addon1" id = "seccion" name = "seccion">
                                </div>
                            </form>
                            <button class = "form100" id = "form_button3" style = "margin-left: 439px;">
                                Registrar
                            </button>   
                        </div><br>                             
                        <div class="card mb-4">
    ...
    <script src = "<?php echo APP;?>app/plugins/fontawesome-free/js/solid.min.js"></script>

                                ...
                                <div class="modal-dialog" role="document" style = "margin-right: 300px;">
                                    <div class="modal-content" style="width: 350px;">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel" style = "color:green">Actualizar Materia</h5>
                            ...
                            <form id = "form" class = "form">
                               <div style = "width: 300px; margin-left: 880px;" class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="basic-addon1"><strong>Materia:</strong></span>
                                    </div>
                                    <input  type="text" class="form-control" aria-label = "Username" aria-describedby="basic-addon1" id = "Materia" name = "Materia">
                                </div>
                            </form>
                            <button class = "form100" id = "form_button" style = "margin-left: 439px;">
                                Registrar
                            </button>   
                        </div><br>                             
                       <div class="card mb-4">
